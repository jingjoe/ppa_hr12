...
<div class="wrap">
    <?php
    NavBar::begin([
        'brandLabel' => '<span class="glyphicon glyphicon-equalizer"></span>  PPA - 2561',
...
$menuItems = [
    ...
    ['label' => '<span class="glyphicon glyphicon-search"></span> รายงาน', 'url' => ['/report2/index']],
...
<footer class="footer">
      ...
      <div class="container">
            <?php
                ...
                $ver = explode(',', $ver);
            ?>    
          <p class="pull-left">P&P Area Based &copy;  <?= date('Y') ?> <a href="https://is.sasuk12.com" target="_blank">ทีมพัฒนาระบบสารสนเทศ เขตสุขภาพที่ 12</a> <b>Version : <?= $ver[0] ?> </b></p>
