...
$this->params['breadcrumbs'][] = ['label' => 'Go Back', 'url' => ['ppa2562/epifully','cyear'=>$cyear,'provcode'=>$provcode]];
...
<br>
 ...
 ?>
    <?=GridView::widget([
            ...
            'beforeHeader'=>[
                [
                    'columns'=>[
                        ...
                        ['content'=>'ข้อมูลปี 2562', 'options'=>['colspan'=>4, 'class'=>'text-center warning']], 
	    ...
	    'autoXlFormat'=>true,
            'exportConfig' => [
                   GridView::EXCEL=> ['label' => 'ส่งออกไฟล์ excel', 'filename' => 'epifully_detail'.date('Y-d-m')],
                ],
        // set your toolbar
            'toolbar' =>  [
                ['content' => 
                    Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['detailepi', 'cyear' => $cyear, 'provcode' => $provcode,'hospcode' => $hosmain], ['data-pjax' => 0, 'class' => 'btn btn-default', 'title' => Yii::t('app', 'รีเซ็ต')])
                ],
                '{toggleData}',
                '{export}',
            ], 
